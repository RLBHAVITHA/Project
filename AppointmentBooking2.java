...
import java.util.*;
//import java.io.*;
public class AppointmentBooking2{
...
*/
		...
		doctorPassword.add("Lavanya123");
		doctorPassword.add("Bhavitha123");
		...
		doctorCity.add("Hyd");
		doctorCity.add("Hyd");
		doctorCity.add("Uppal");
		doctorCity.add("ECIL");
		doctorCity.add("Madhapur");
		doctorCity.add("Chadhargat");
		doctorCity.add("Mehifhipatnam");
	...
	{
		AppointmentBooking2 ap=new AppointmentBooking2();
		Scanner sc=new Scanner(System.in);
		ap.dataAdd();
		boolean flag=false;
		while(flag=true)
